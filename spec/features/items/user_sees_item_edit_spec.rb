RSpec.describe 'User' do
  before(:each) do
      ...
      @item_1 = @merchant_1.items.create(title: "jeans", description: "lovely", unit_price: 500, image: 'https://www.kesslerandsons.com/wp-content/uploads/2015/04/yanagisawa-awo37-alto-logo.jpg')
  end
